...
const allProjectImages = [
  ...
  // Church Events (30 items)
  { src: '/projects/Church designs/ANOINTING service.jpg', category: 'Church Events', title: 'Anointing Service' },
  { src: '/projects/Church designs/Bible study.jpg', category: 'Church Events', title: 'Bible Study' },
  { src: '/projects/Church designs/CALL upon the lord.jpg', category: 'Church Events', title: 'Call Upon The Lord' },
  { src: '/projects/Church designs/CROSS-OVER.jpg', category: 'Church Events', title: 'Cross Over' },
  { src: '/projects/Church designs/Call upon the lord2.jpg', category: 'Church Events', title: 'Call Upon The Lord 2' },
  { src: '/projects/Church designs/DIGGING DEEP.jpg', category: 'Church Events', title: 'Digging Deep' },
  { src: '/projects/Church designs/Faith clinic.jpg', category: 'Church Events', title: 'Faith Clinic' },
  { src: '/projects/Church designs/HOG Thanksgiving.jpg', category: 'Church Events', title: 'HOG Thanksgiving' },
  { src: '/projects/Church designs/HOG(1).jpg', category: 'Church Events', title: 'HOG 1' },
  { src: '/projects/Church designs/HOG.jpg', category: 'Church Events', title: 'HOG' },
  { src: '/projects/Church designs/PRAYER CONFERENCE  anointing service February.jpg', category: 'Church Events', title: 'Prayer Conference February' },
  { src: '/projects/Church designs/SOD.jpg', category: 'Church Events', title: 'SOD' },
  { src: '/projects/Church designs/SOUNDS.jpg', category: 'Church Events', title: 'Sounds' },
  { src: '/projects/Church designs/SPECIAL CAMP MEETING ( SCM ).jpg', category: 'Church Events', title: 'Special Camp Meeting' },
  { src: '/projects/Church designs/Xmas.jpg', category: 'Church Events', title: 'Christmas' },
  { src: '/projects/Church designs/backdrop.jpg', category: 'Church Events', title: 'Backdrop' },
  { src: '/projects/Church designs/blank.jpg', category: 'Church Events', title: 'Blank Template' },
  { src: '/projects/Church designs/call upon the lord(1).jpg', category: 'Church Events', title: 'Call Upon The Lord Alt' },
  { src: '/projects/Church designs/church banner.jpg', category: 'Church Events', title: 'Church Banner' },
  { src: '/projects/Church designs/deliverance service2.jpg', category: 'Church Events', title: 'Deliverance Service' },
  { src: '/projects/Church designs/power night1.jpg', category: 'Church Events', title: 'Power Night' },
  { src: '/projects/Church designs/prayer conference 2.png', category: 'Church Events', title: 'Prayer Conference 2' },
  { src: '/projects/Church designs/prayer conference November edition.jpg', category: 'Church Events', title: 'Prayer Conference November' },
  { src: '/projects/Church designs/prayer conference feb.jpg', category: 'Church Events', title: 'Prayer Conference Feb' },
  { src: '/projects/Church designs/prayer conference october1.jpg', category: 'Church Events', title: 'Prayer Conference October' },
  { src: '/projects/Church designs/prayer conference2.jpg', category: 'Church Events', title: 'Prayer Conference 2 Alt' },
  { src: '/projects/Church designs/rcftry.jpg', category: 'Church Events', title: 'RCF Try' },
  { src: '/projects/Church designs/recreate.jpg', category: 'Church Events', title: 'Recreate' },
  { src: '/projects/Church designs/rememeber.jpg', category: 'Church Events', title: 'Remember' },
  { src: '/projects/Church designs/sunday.jpg', category: 'Church Events', title: 'Sunday Service' },
  ...
  // YouTube Assets (6 items)
  { src: '/projects/Youtube (banners,Thumbnails & Dp)/BANNER.jpg', category: 'YouTube Assets', title: 'YouTube Banner' },
  { src: '/projects/Youtube (banners,Thumbnails & Dp)/HOG.jpg', category: 'YouTube Assets', title: 'HOG Thumbnail' },
  { src: '/projects/Youtube (banners,Thumbnails & Dp)/call upon the lord.jpg', category: 'YouTube Assets', title: 'Call Upon The Lord Thumb' },
  { src: '/projects/Youtube (banners,Thumbnails & Dp)/daddy g.o2.jpg', category: 'YouTube Assets', title: 'Daddy GO' },
  { src: '/projects/Youtube (banners,Thumbnails & Dp)/new months.jpg', category: 'YouTube Assets', title: 'New Months Thumb' },
  { src: '/projects/Youtube (banners,Thumbnails & Dp)/utube banner.jpg', category: 'YouTube Assets', title: 'YouTube Banner Alt' },
